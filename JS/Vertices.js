...
export const TESSERACT_QUAD_INDICES = [
	// -X Normal Cell
	1, 9, 13, 5,
	3, 7, 15, 11,
	9, 11, 15, 13,
...
export const TESSERACT_WIREFRAME_INDICES = [
	0, 1,
	1, 3,
	3, 2,
	2, 0,
...
export const TESSERACT_VERTICES5 = [
	// Each vertex is defined by (x, y, z, w, 1) with all combinations of 0 and 1 for each dimension.
	0 - 0.5, 0 - 0.5, 0 - 0.5, 0 - 0.5, 1,
	1 - 0.5, 0 - 0.5, 0 - 0.5, 0 - 0.5, 1,
	0 - 0.5, 1 - 0.5, 0 - 0.5, 0 - 0.5, 1,
	1 - 0.5, 1 - 0.5, 0 - 0.5, 0 - 0.5, 1,
	0 - 0.5, 0 - 0.5, 1 - 0.5, 0 - 0.5, 1,
	1 - 0.5, 0 - 0.5, 1 - 0.5, 0 - 0.5, 1,
	0 - 0.5, 1 - 0.5, 1 - 0.5, 0 - 0.5, 1,
	1 - 0.5, 1 - 0.5, 1 - 0.5, 0 - 0.5, 1,
	0 - 0.5, 0 - 0.5, 0 - 0.5, 1 - 0.5, 1,
	1 - 0.5, 0 - 0.5, 0 - 0.5, 1 - 0.5, 1,
	0 - 0.5, 1 - 0.5, 0 - 0.5, 1 - 0.5, 1,
	1 - 0.5, 1 - 0.5, 0 - 0.5, 1 - 0.5, 1,
	0 - 0.5, 0 - 0.5, 1 - 0.5, 1 - 0.5, 1,
	1 - 0.5, 0 - 0.5, 1 - 0.5, 1 - 0.5, 1,
